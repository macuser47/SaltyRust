...
public class LibRocket {
   ...
   public void detectChangesAndReload() {
      if (this.getActiveDocument() != null) {
         ...
         if (var1) {
            boolean var6 = false;
            this.setDocument(this.currentDocumentPath, this.getActiveDocumentMetadata(), var6);
         }
      }
   ...
   public native void setDimensions(int var1, int var2);
   ...
   public int CompileGeometry(float[] var1, float[] var2, int[] var3, int[] var4, int var5) {
      ...
      if (!var11) {
         var6.field_3993 = this.compiledGeometryList.size();
         this.compiledGeometryList.add(var6);
      }

      return var6.field_3993;
   }
