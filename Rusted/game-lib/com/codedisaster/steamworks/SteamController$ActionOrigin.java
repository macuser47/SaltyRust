...
public enum SteamController$ActionOrigin {
   None,
   // $FF: renamed from: A com.codedisaster.steamworks.SteamController$ActionOrigin
   field_3758,
   // $FF: renamed from: B com.codedisaster.steamworks.SteamController$ActionOrigin
   field_3759,
   // $FF: renamed from: X com.codedisaster.steamworks.SteamController$ActionOrigin
   field_3760,
   // $FF: renamed from: Y com.codedisaster.steamworks.SteamController$ActionOrigin
   field_3761,
   LeftBumper,
   RightBumper,
   LeftGrip,
