...
// $FF: renamed from: com.corrodinggames.rts.a.n
public class class_269 extends class_266 {
   ...
   public static String[] method_1877() {
      String[] var0 = class_236.method_1638("/SD/rustedWarfare/replays/", false);
      if (var0 == null) {
         return null;
      } else {
         ...
         Collections.sort(var1, new class_354());
