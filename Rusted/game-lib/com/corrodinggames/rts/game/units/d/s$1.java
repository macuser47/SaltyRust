...
final class s$1 extends class_134 {
   s$1(int var1) {
      super(var1);
   }
   ...
   public String method_1045() {
      return class_432.method_2744("units.supplyDepot.upgrade.description");
   }

   // $FF: renamed from: b () java.lang.String
   public String method_1044() {
      return class_432.method_2744("units.supplyDepot.upgrade.name");
   }
   ...
   public boolean method_1050(class_39 var1, boolean var2) {
      class_63 var3 = (class_63)var1;
      return var3.field_522 == 1 && var3.a(this.v(), var2) <= 0 ? super.b(var1, var2) : false;
   }

   // $FF: renamed from: B () com.corrodinggames.rts.game.units.ao
   public class_469 method_1118() {
      return null;
   }
