      ...
      if (var1 == -1) {
         ...
         if (this.buffer == null) {
            ...
            try {
               ...
               throw new class_145("Failure reading Vorbis.", var5);
            }
            ...
            if (this.syncState.pageout(this.page) != 1) {
               if (this.bytes < 512) {
                  ...
                  throw new class_145("Input does not appear to be an Ogg bitstream.");
               }
            } else {
               ...
               if (this.streamState.pagein(this.page) < 0) {
                  throw new class_145("Error reading first page of Ogg bitstream.");
               } else if (this.streamState.packetout(this.packet) != 1) {
                  throw new class_145("Error reading initial header packet.");
               } else if (this.oggInfo.synthesis_headerin(this.comment, this.packet) < 0) {
                  throw new class_145("Ogg bitstream does not contain Vorbis audio data.");
               } else {
                  int var2 = 0;
                  ...
                  while(var2 < 2) {
                     ...
                     while(true) {
                        ...
                        while(var2 < 2) {
                           ...
                           if (var3 == -1) {
                              throw new class_145("Corrupt secondary header.");
                           }
                     ...
                     try {
                        ...
                        throw new class_145("Failed to read Vorbis.", var4);
                     }

                     if (this.bytes == 0 && var2 < 2) {
                        throw new class_145("End of file before finding all Vorbis headers.");
                     }
         ...
         while(!this.endOfBitStream) {
            ...
            while(true) {
               ...
               while(true) {
                  ...
                  if (var4 == -1) {
                     class_236.method_1592("gdx-audio", "Error reading OGG: Corrupt or missing data in bitstream.");
                  } else {
                     this.streamState.pagein(this.page);
                     ...
                     while(true) {
                        ...
                        while((var5 = this.dspState.synthesis_pcmout(var2, var3)) > 0) {
                           ...
                           if (this.outIndex + var8 > this.outBuffer.length) {
                              throw new class_145("Ogg block too big to be buffered: " + var8 + ", " + (this.outBuffer.length - this.outIndex));
                           }
            ...
            if (!this.endOfBitStream) {
               ...
               if (var4 >= 0) {
                  ...
                  try {
                     ...
                     throw new class_145("Error during Vorbis decoding.", var13);
                  }
               } else {
                  this.bytes = 0;
               }
