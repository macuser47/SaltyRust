...
import com.corrodinggames.rts.java.audio.a.class_146;
...
public abstract class OpenALMusic implements Music {
   ...
   private class_146 renderedSecondsQueue = new class_146(3);
      ...
      if (!this.audio.noDevice) {
         if (this.sourceID == -1) {
            ...
            if (this.buffers == null) {
               ...
               if (var1 != 0) {
                  throw new class_145("Unable to allocate audio buffers. AL Error: " + var1);
               }
            }
   ...
   public void stop() {
      if (!this.audio.noDevice) {
         if (this.sourceID != -1) {
            ...
            this.renderedSecondsQueue.method_1138();
   ...
   public void setPan(float var1, float var2) {
      ...
      if (!this.audio.noDevice) {
         if (this.sourceID != -1) {
            AL10.alSource3f(this.sourceID, 4100, class_177.method_1246((var1 - 1.0F) * 3.1415927F / 2.0F), 0.0F, class_177.method_1245((var1 + 1.0F) * 3.1415927F / 2.0F));
   ...
   public void setPosition(float var1) {
      if (!this.audio.noDevice) {
         if (this.sourceID != -1) {
            ...
            while(this.renderedSecondsQueue.field_1385 > 0) {
               this.renderedSeconds = this.renderedSecondsQueue.method_1136();
            }
            ...
            this.renderedSecondsQueue.method_1133(this.renderedSeconds);
            boolean var3 = false;
            ...
            this.renderedSecondsQueue.method_1136();
            if (!var3) {
               this.stop();
   ...
   private boolean fill(int var1) {
      ...
      if (var2 <= 0) {
         ...
         if (this.renderedSecondsQueue.field_1385 > 0) {
            this.renderedSecondsQueue.method_1134(0, 0.0F);
         }
      }

      float var3 = this.renderedSecondsQueue.field_1385 > 0 ? this.renderedSecondsQueue.method_1137() : 0.0F;
      float var4 = this.maxSecondsPerBuffer * (float)var2 / 40960.0F;
      this.renderedSecondsQueue.method_1135(0, var3 + var4);
